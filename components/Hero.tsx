        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-[10px] md:text-xs font-bold tracking-[0.4em] uppercase text-white/90 font-display">
            ...
            >
              I&apos;m{" "}
              <span className="text-white font-bold">Redoan Ahmad</span> — a
              full-stack developer dedicated to crafting fast, beautiful, and
              accessible web experiences using React, Next.js and Node.js.
            </motion.p>
            ...
            >
              {[
                ...
                >
                  <span className="block text-2xl md:text-3xl font-black font-display text-accent mb-1 tracking-tight">
                    {stat.num}
                  </span>
